  ...
  return (
    <div>
      ...
      <form onSubmit={submithandler}>
        <div className="form-group get-in-touch-2">
          <p>GET IN TOUCH</p>

          <div>
            <div className="input-2">
              <div>
                <input className="form-control mt-0 mb-0" placeholder="Your Name" value={name} onChange={(e) => { setName(e.target.value) }} />
                <hr />
              </div>
              <div>
                <input className="form-control mt-0 mb-0" placeholder="Email Address" value={email} onChange={(e) => { setEmail(e.target.value) }} />
                <hr />
              </div>
            </div>
            ...
            <div className="input-2">
              <div>
                <select className="select-box-2 form-control mt-0 mb-0" onChange={(e) => { setCountrycode(e.target.value) }} >
            ...
            {!show && (
              <div className="input-2">
                <div>
                  <select className="select-box-2 form-control" onChange={(e) => { setWhatsupcountrycode(e.target.value) }}>
                    <option defaultValue="selected" value="India">
                      IND (+91)
                    </option>
                    <option value="Andorra">AND (+376)</option>
            ...
            <div className="input-2">
              <div>
                <select className="select-box-2 form-control" onChange={(e) => { setCountry(e.target.value) }}>
              ...
              <div>
                <select className="form-control select-box-2" onChange={(e) => { setVisaCountry(e.target.value) }}>
            ...
            <div className="input-2">
              <div style={{ width: "90%" }}>
                {" "}
                <textarea className="form-control" rows="2" placeholder="Message" value={message} onChange={(e) => { setMessage(e.target.value) }} />


              </div>
            </div>
          </div>
          <button type="submit" className="px-4 border-0 rounded-3 text-white fs-5 py-1 mb-3 bg-info mt-4">Get Started</button>
        </div>
      </form>
    </div>
  );
