            ...
            <div className='pt-0'>
                ...
                <div className='parent-container' style={{ position: 'relative' }}>
                    ...
                    <div className='overlay z-4' style={{ backgroundColor: "#010206", height: '100%', position: 'absolute', top: 0, left: 0, width: '100%', opacity: '55%' }}>
                        <h1 className='title_text' style={{ fontWeight: "600" }}>France Details</h1>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-12">
                            <div className="country-details__img mt-3">
                                <img className='country-img' style={{ height: "380px" }} src="/Dependent-img/France.jpg" alt="" /> </div>
                        </div>
                        <div className="col-lg-6 col-md-12">
                            <div className="country-content">
                                <h1 className='country-title'>France</h1>
                                <p className='fs-5 text-secondary country-text' style={{ fontWeight: '500' }}>
                                    France, famed for its cultural richness and historic landmarks, captivates with Parisian elegance, world-class cuisine, and scenic landscapes. From the iconic Eiffel Tower to the sun-kissed shores of the French Riviera, each corner offers a tapestry of art, history, and gastronomy, making it a timeless destination for travelers worldwide.
                                </p>
