            ...
            <div className='pt-0'>
                ...
                <div className='parent-container' style={{ position: 'relative' }}>
                    ...
                    <div className='overlay z-4' style={{ backgroundColor: "#010206", height: '100%', position: 'absolute', top: 0, left: 0, width: '100%', opacity: '55%' }}>
                        <h1 className='title_text' style={{ fontWeight: "600" }}>Italy Details</h1>
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-12">
                            <div className="country-details__img">
                                <img className='country-img' style={{ height: "380px" }} src="/Dependent-img/Italy.jpg" alt="" /> </div>
                        </div>
                        <div className="col-lg-6 col-md-12">
                            <div className="country-content">
                                <h1 className='country-title'>Italy</h1>
                                <p className='fs-5 text-secondary country-text' style={{ fontWeight: '500' }}>
                                    Italy, in southern Europe, is famed for its rich history, art, and cuisine. Home to iconic landmarks such as the Colosseum, Vatican City, and Renaissance masterpieces, it offers a blend of ancient charm and modern vibrancy, attracting millions of visitors annually.
                                </p>
